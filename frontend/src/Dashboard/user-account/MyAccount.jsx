...
import img01 from "../../assets/images/about.jpg";
      ...
      <div className="grid md:grid-cols-3 gap-10">
        <div className="pb-[50px] px-[30px] rounded-md">
          <div className="flex items-center justify-center">
            <figure className="w-[100px] h-[100px] border-solid rounded-full border-2 border-primaryColor">
              <img src={img01} alt="" className="w-full h-full rounded-full" />
            </figure>
          </div>
