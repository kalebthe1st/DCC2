...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5 ">
      <div>
        <img
          style={{ height: "400px", width: "300px", borderRadius: "12px" }}
          src={photo}
          alt=""
        />
      </div>
      ...
      <div className="mt-2 lg:mt-4 flex items-center justify-between">
        <span
          className="bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:py-2 lg:px-6 text-[18px] leading-4 
